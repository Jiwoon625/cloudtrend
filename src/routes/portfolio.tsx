...
import { BriefcaseBusiness, Loader2, RefreshCw, Save } from "lucide-react";
        ...
        <>
          ...
          <section className="overflow-hidden rounded-lg border border-border bg-card">
            <div className="border-b border-border bg-surface-strong px-3 py-2">
              <h2 className="text-sm font-semibold">매수·매도 원장</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[2050px] text-[11px]">
                <thead>
