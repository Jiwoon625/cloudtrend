...
describe("buildInstrumentDetailDataset", () => {
  it("keeps the selected instrument and market indexes needed by the parser", () => {
    const source = [
      ...
      ...indexRows("KOSPI"),
      ...indexRows("KOSDAQ"),
      ["005930", "삼성전자", "KOSPI", "STOCK", dateAt(59), 70000, 71000, 69000, 70500, 1000, 70500000].join(","),
      ["000660", "SK하이닉스", "KOSPI", "STOCK", dateAt(59), 300000, 301000, 295000, 299000, 1000, 299000000].join(","),
    ].join("\n");
